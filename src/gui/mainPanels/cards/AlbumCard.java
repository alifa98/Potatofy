...
public class AlbumCard extends JPanel {
    ...
    public AlbumCard(String albumName, File coverFile, int songNumber) {
        ...
        // Album name label
        JLabel artistNameLabel = new JLabel(albumName);
        ...
        //number of songs in album label
        songNumberLabel = new JLabel(songNumber+" Songs");
    ...
    //todo add listenet to onclick open album song panel
}
